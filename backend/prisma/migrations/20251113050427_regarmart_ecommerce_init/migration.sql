-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'SHIPPED', 'COMPLETED', 'CANCELED');

-- CreateEnum
CREATE TYPE "public"."PaymentMethod" AS ENUM ('COD', 'QRIS');
...
-- AddForeignKey
ALTER TABLE "public"."Review" ADD CONSTRAINT "Review_replyBy_fkey" FOREIGN KEY ("replyBy") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
